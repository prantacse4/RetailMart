...
<main>
  ...
  <div class="container">
    <div class="card-header myheader"><h4>Products</h5><span><a href="{{ route('add_products') }}" class="btn btn-success textright">Add Products</a></span></div>
        ...
        <table class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="{{ route('edit_products', $product->id) }}" class="btn btn-info">Edit</a> <span>
                    
                    <button  class="btn btn-danger acbtn2"
                onclick="event.preventDefault();document.getElementById('form-delete-id-{{ $product->id }}').submit();">Delete</button>
                 <form id="{{ 'form-delete-id-'.$product->id }}" action="{{route('delete_products',$product->id)}}" method="POST" style="display: none;">
                 @csrf
                @method('delete') </form>
                </span>
                </td>
